...
# Delete the job if it already exists. If it doesn't exist, the last ||: ensures, the exit code
# is still success and the script continues on.
...
--as-parquetfile --hive-import --warehouse-dir /data/movielens --hive-table user_rating_fact
