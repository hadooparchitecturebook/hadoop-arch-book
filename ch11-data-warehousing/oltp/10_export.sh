...
sqoop export --connect jdbc:mysql://mgrover-haa-4.vpc.cloudera.com:3306/movie_dwh --username root --table avg_movie_rating --export-dir /user/hive/warehouse/avg_movie_rating -m 16 --update-key movie_id
